...
Define penalized complexity prior for spatial random effect and for temporal effect. Also define some other priors to investigate effect of changing prior (the original precision prior yields the best results).
