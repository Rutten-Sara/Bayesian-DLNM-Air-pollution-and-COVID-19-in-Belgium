...
```{r}
source(knitr::purl("04_crossbasis_definition_additional_covariates.rmd", quiet=TRUE))
...
load("../output/models/Additional covariates/model.bc.RData")
...
pdf("figs/bc_scenario_additional.pdf", width = 6, height = 6)
...
pdf("figs/bc_contour_additional.pdf", width = 8, height = 6)
...
```{r}
pdf("figs/bc_cumul_contour_additional.pdf", width = 8, height = 6)
...
```{r}
#Extract full coef and vcov and create indicators for each term
load("../output/models/Additional covariates/model.ozone.RData")
coef <- model$summary.fixed$mean
vcov <- model$misc$lincomb.derived.covariance.matrix
...
```{r}
#Extract full coef and vcov and create indicators for each term
load("../output/models/Additional covariates/model.no2.RData")
coef <- model$summary.fixed$mean
vcov <- model$misc$lincomb.derived.covariance.matrix
...
```{r}
#Extract full coef and vcov and create indicators for each term
load("../output/models/Additional covariates/model.pm10.RData")
coef <- model$summary.fixed$mean
vcov <- model$misc$lincomb.derived.covariance.matrix
...
```{r}
#Extract full coef and vcov and create indicators for each term
load("../output/models/Additional covariates/model.pm25.RData")
coef <- model$summary.fixed$mean
vcov <- model$misc$lincomb.derived.covariance.matrix
